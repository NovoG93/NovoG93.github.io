...
- [Setting up a Kubernetes Cluster the Hard Way with kubeadm (GitOps Series, Part 1)](#setting-up-a-kubernetes-cluster-the-hard-way-with-kubeadm-gitops-series-part-1)
    - [Part 1: Setting up the Kubernetes cluster from scratch using kubeadm](#part-1-setting-up-the-kubernetes-cluster-from-scratch-using-kubeadm)
    - [Part 2: Deploying Core Infrastructure applications and cluster tools](#part-2-deploying-core-infrastructure-applications-and-cluster-tools)
    - [Part 3: Managing the cluster using App of Apps Principles](#part-3-managing-the-cluster-using-app-of-apps-principles)
- [Part 1: Setting up the Kubernetes cluster from scratch using kubeadm](#part-1-setting-up-the-kubernetes-cluster-from-scratch-using-kubeadm-1)
  ...
  - [Setting up the Kubernetes cluster from scratch using kubeadm](#setting-up-the-kubernetes-cluster-from-scratch-using-kubeadm)
    - [Installing kubeadm and joining worker nodes](#installing-kubeadm-and-joining-worker-nodes)
      ...
      - [Configuring the Control Plane Node](#configuring-the-control-plane-node)
        - [Installing Helm and Kustomize (optional)](#installing-helm-and-kustomize-optional)
