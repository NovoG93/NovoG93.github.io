...
header:
  teaser: rcl/Book_Cover_Full_page-0001.jpg
gallery:
  - url: rcl/Linux_terminal_VSCode1.webp
    image_path: rcl/Linux_terminal_VSCode1.webp
    alt: "Master the Linux Terminal in VS Code"
    title: "Master the Linux Terminal in VS Code"
  - url: rcl/Linux_terminal_VSCode2.webp
    image_path: rcl/Linux_terminal_VSCode2.webp
    alt: "Advanced Terminal Workflows"
    title: "Advanced Terminal Workflows"
  - url: rcl/Windows_terminal_drone_cover.webp
    image_path: rcl/Windows_terminal_drone_cover.webp
    alt: "Drone Simulation Control"
    title: "Drone Simulation Control"
  - url: rcl/Windows_terminal_pub_sub.webp
    image_path: rcl/Windows_terminal_pub_sub.webp
    alt: "ROS 2 Pub/Sub Communication"
    title: "ROS 2 Pub/Sub Communication"
  - url: rcl/Windows_vnc_robotino_tf.webp
    image_path: rcl/Windows_vnc_robotino_tf.webp
    alt: "Robotino TF & VNC Integration"
    title: "Robotino TF & VNC Integration"
---
...
*   <i class="fas fa-check-circle"></i> Master ROS 2 fundamentals
*   <i class="fas fa-check-circle"></i> Build modular robot systems
*   <i class="fas fa-check-circle"></i> Hands-on Python implementation
*   <i class="fas fa-check-circle"></i> Best practices for robotics software

<!-- <a href="https://leanpub.com/rclpy" class="btn btn--success"><i class="fas fa-shopping-cart"></i> Buy on Leanpub</a>
...
<img src="/images/rcl/Linux_terminal_VSCode1.webp" alt="Part 1: The Foundation">
<br/>
...
<img src="/images/rcl/Windows_terminal_drone_cover.webp" alt="Part 2: Advanced Concepts">
<br/>
...
<img src="/images/rcl/Windows_vnc_robotino_tf.webp" alt="Part 3: Real-World Robotics">
<br/>
